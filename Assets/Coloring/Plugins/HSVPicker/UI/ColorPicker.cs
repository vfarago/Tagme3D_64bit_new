...
public class ColorPicker : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
	...
	public void OnDrag (PointerEventData data)
	{
		...
		//if (data.pointerDrag == gameObject) {
		//	RectTransform rectTransform = GetComponent<RectTransform> ();
		//	rectTransform.localPosition = new Vector3 (rectTransform.localPosition.x + data.delta.x, rectTransform.localPosition.y + data.delta.y, rectTransform.localPosition.z);
		//}
	}
